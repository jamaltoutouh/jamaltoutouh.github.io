...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/feeling-responsive" class="icon-tree"> NeCOL</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/feeling-responsive/" title="NeCOL – LOLOLOLO">
				<img src="http://localhost:4000/feeling-responsive/assets/img/logo.png" alt="NeCOL – LOLOLOLO">
			</a>
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>MARIE-CORIE H2020 y esas cosasCreated with &hearts; by <a href="http://phlow.de/">Phlow</a> with <a href="http://jekyllrb.com/" target="_blank">Jekyll</a> based on <a href="http://phlow.github.io/feeling-responsive/">Feeling Responsive</a>.</p>
          </section>

          <section id="subfooter-right" class="small-12 medium-6 columns">
            <ul class="inline-list social-icons">
            
              <li><a href="http://github.com/jamaltoutouh" target="_blank" class="icon-github" title="GitHub projects"></a></li>
            
              <li><a href="http://twitter.com/jamtouh" target="_blank" class="icon-twitter" title="Twitter"></a></li>
